...
imgMini1.addEventListener("click",function(){
    imgBox.setAttribute("src","img/XTZ 250-BLANCA.png")
...
imgMini2.addEventListener("click",function(){
    imgBox.setAttribute("src","img/XTZ 250 NEGRA.png")
...
imgMini3.addEventListener("click",function(){
    imgBox.setAttribute("src","img/xtz 250-azul.png")
...
imgMiniEsc1.addEventListener("click",function(){
    imgEscPrin.setAttribute("src","img/XTZ 250-BLANCA.png");
...
imgMiniEsc2.addEventListener("click",function(){
    imgEscPrin.setAttribute("src","img/XTZ 250 NEGRA.png")
...
imgMiniEsc3.addEventListener("click",function(){
    imgEscPrin.setAttribute("src","img/xtz 250-azul.png")
...
let counter=0;
let numImg=["img/XTZ 250-BLANCA.png","img/XTZ 250 NEGRA.png","img/xtz 250-azul.png"];
